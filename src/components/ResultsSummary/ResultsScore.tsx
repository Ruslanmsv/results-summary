export default function ResultsScore() {
  return (
    <div className="flex lg:max-w-[368px] w-full flex-col items-center rounded-b-4xl bg-gradient pt-6 pb-10 shadow-custom-xl lg:rounded-4xl lg:p-14 lg:pt-10">
      ...
      <p className="mt-2 text-center text-sm font-medium text-lavender lg:mt-4 lg:text-md ">
        ...
        <br className="lg:hidden"/> the people conducting the <br className="hidden lg:inline" />test here!
      </p>
    </div>
  );
}
